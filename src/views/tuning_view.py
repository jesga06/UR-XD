...
class TuningView(QWidget):
    ...
    def setup_ui(self):
        ...
        grid_l.addWidget(lbl_l_adz, 1, 0)
        ...
        grid_l.addWidget(lbl_l_rdz, 2, 0)
        ...
        grid_l.addWidget(lbl_l_warp, 3, 0)
        ...
        grid_l.addWidget(lbl_l_sens, 5, 0)
        ...
        self.combo_l_ctype.setToolTip("Select response curve mapping algorithm.")
        ...
        ctype_l_box.addWidget(lbl_l_ctype)
        ...
        grid_r.addWidget(lbl_r_adz, 1, 0)
        ...
        grid_r.addWidget(lbl_r_rdz, 2, 0)
        ...
        grid_r.addWidget(lbl_r_warp, 3, 0)
        ...
        grid_r.addWidget(lbl_r_sens, 5, 0)
        ...
        self.combo_r_ctype.setToolTip("Select response curve mapping algorithm.")
        ...
        ctype_r_box.addWidget(lbl_r_ctype)
        ...
        grid_lt.addWidget(lbl_lt_dz, 0, 0)
        ...
        grid_lt.addWidget(lbl_lt_adz, 1, 0)
        ...
        grid_lt.addWidget(lbl_lt_rdz, 2, 0)
        ...
        grid_lt.addWidget(lbl_lt_exp, 3, 0)
        ...
        grid_lt.addWidget(lbl_lt_sens, 4, 0)
        ...
        self.combo_lt_ctype.setToolTip("Select trigger response curve mapping algorithm.")
        ...
        ctype_lt_box.addWidget(lbl_lt_ctype)
        ...
        grid_rt.addWidget(lbl_rt_dz, 0, 0)
        ...
        grid_rt.addWidget(lbl_rt_adz, 1, 0)
        ...
        grid_rt.addWidget(lbl_rt_rdz, 2, 0)
        ...
        grid_rt.addWidget(lbl_rt_exp, 3, 0)
        ...
        grid_rt.addWidget(lbl_rt_sens, 4, 0)
        ...
        self.combo_rt_ctype.setToolTip("Select trigger response curve mapping algorithm.")
        ...
        ctype_rt_box.addWidget(lbl_rt_ctype)
