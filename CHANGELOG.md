...
- **High-Contrast Remapping Text Box Outlines:** Added `QLineEdit#OutlinedEdit` QSS styling rules in `ThemeManager` ensuring visible 1.5px outlines and clear focus states across all remapping text inputs in every color theme.
