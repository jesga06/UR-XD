...
from PySide6.QtWidgets import (
    QMainWindow, QTabWidget, QWidget, QVBoxLayout, QScrollArea, QLabel, QApplication
)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, controller_config=None):
        ...
        # Connect dynamic theme engine
        self.theme_mgr.theme_changed.connect(self.apply_theme_qss)
        self.apply_theme_qss()

    @Slot(dict)
    def apply_theme_qss(self, tokens: dict = None) -> None:
        """Applies application-wide dynamic QSS generated by ThemeManager."""
        app = QApplication.instance()
        if app:
            app.setStyleSheet(self.theme_mgr.generate_qss())
